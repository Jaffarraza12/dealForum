...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    ...
    <div class="app-body">
        ...
        <div class="modal fade bd-example-modal-lg" id="jr_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
       ...
       <div class="footer"  style="background: #262626;">
        <footer>
            <div class="color-white" style="text-align: center;color:#fff;">Developed by <a href="https//:appertunity.net">Appertunity</a></div>
        </footer>
    </div>
